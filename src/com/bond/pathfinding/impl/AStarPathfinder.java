...
import com.bond.pathfinding.interfaces.Pathfinder;
...
public class AStarPathfinder implements Pathfinder {
     ...
     */
    public AStarPathfinder(GameGrid map, int maxSearchDistance, boolean allowDiagMovement) {
     ...
     * @param allowDiagMovement True if the search should try diaganol movement
     */
    public AStarPathfinder(GameGrid map, int maxSearchDistance,
